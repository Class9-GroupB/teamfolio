...
## 🚀 Live Website  
**➡️ http://emmanuel-teamfolio-profile.s3-website.ca-central-1.amazonaws.com**  
...
- **CSS3** (embedded styles, responsive layout)
...
1. Created an S3 bucket (public access allowed for website hosting)
2. Enabled **Static Website Hosting** (index document = `index.html`)
3. Uploaded:
   - `index.html`
   - `profile.jpg`
4. Added a bucket policy to allow public GET access
5. Accessed the site via the S3 **Website Endpoint**
